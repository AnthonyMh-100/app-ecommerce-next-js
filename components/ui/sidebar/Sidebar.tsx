...
export const Sidebar = () => {
  ...
  return (
    <div>
      ...
      {isSideMenuOpen && (
        <div className="fade-in fixed left-0 w-screen h-screen z-10 backdrop-filter backdrop-blur-sm" />
      )}
      <nav
        className={clsx(
      ...
      >
        ...
        {isAuthenticated && (
          <button
            ...
            className="w-full cursor-pointer flex items-center mt-10 p-2 hover:bg-gray-50 rounded transition-all"
          >
